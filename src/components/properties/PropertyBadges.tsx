...
export default function PropertyBadges({ property, size = 'sm' }: PropertyBadgesProps) {
  const badges = [
    ...
    property.forBusiness && { label: '💼 Negocios', color: 'bg-blue-50 text-blue-700 border-blue-200' },
    property.forPatrimony && { label: '🏛️ Patrimonio', color: 'bg-amber-50 text-amber-700 border-amber-200' },
