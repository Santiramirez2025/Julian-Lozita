...
export default function Navbar() {
  ...
  const whatsappMessage = encodeURIComponent('Hola Julián, me interesa recibir asesoramiento sobre una decisión inmobiliaria/patrimonial.')
